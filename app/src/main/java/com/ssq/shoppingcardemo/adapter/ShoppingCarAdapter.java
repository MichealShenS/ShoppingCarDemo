package com.ssq.shoppingcardemo.adapter;
...
import com.ssq.shoppingcardemo.R;
import com.ssq.shoppingcardemo.bean.ShoppingCarDataBean;
import com.ssq.shoppingcardemo.util.ToastUtil;
...
//            Picasso.with(context).load(goods_image).into(childViewHolder.ivPhoto);
//        } else {
//            Picasso.with(context).load(R.mipmap.ic_launcher).into(childViewHolder.ivPhoto);
//        }
//        Glide.with(context)
//                .load(goods_image)
//                .into(childViewHolder.ivPhoto);
        Glide.with(context).load(goods_image).placeholder(R.mipmap.ic_launcher).error(R.mipmap.ic_launcher).into(childViewHolder.ivPhoto);

//        childViewHolder.ivPhoto.setBackgroundResource(R.mipmap.ic_launcher);
